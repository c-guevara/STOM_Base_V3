...
ui_num = {'설정로그': 1, '종목명데이터': 2, '백테엔진': 3, '기본로그': 4, '타임로그': 5,
          '시스템로그': 6, '백테스트': 7, '사용자수식': 8, 'DB관리': 9, '실현손익': 10,
          '거래목록': 11, '잔고평가': 12, '잔고목록': 13, '체결목록': 14, '당일합계': 15,
          '당일상세': 16, '누적합계': 17, '누적상세': 18, '관심종목': 19, '호가종목': 20,
          '호가체결': 21, '호가잔량': 22, '호가체결2': 23, '스톰라이브1': 24, '스톰라이브2': 25,
          '스톰라이브3': 26, '스톰라이브4': 27, '스톰라이브5': 28, '스톰라이브6': 29, '스톰라이브7': 30,
          '스톰라이브8': 31, '스톰라이브9': 32, '스톰라이브10': 33, '스톰라이브11': 34, '김프': 35,
          '기업개요': 36, '기업공시': 37, '기업뉴스': 38, '재무년도': 39, '재무분기': 40,
          '상세기록': 41, '차트': 42, '실시간차트': 43, '코스피': 44, '코스닥': 45,
          '트리맵': 46, '트리맵1': 47, '트리맵2': 48, '풍경사진': 49, '홈차트': 50}
...
columns_bt   = ['종목명', '시가총액', '매수시간', '매도시간', '보유시간', '매수가', '매도가', '매수금액', '매도금액', '수익률',
                '수익금', '수익금합계', '매도조건', '추가매수시간']
columns_btf  = ['종목명', '포지션', '매수시간', '매도시간', '보유시간', '매수가', '매도가', '매수금액', '매도금액', '수익률',
                '수익금', '수익금합계', '매도조건', '추가매수시간']
...
columns_sb   = ['구분', '백테스트', '백파인더', '최적화', '최적화V', '최적화VC', '최적화T', '최적화VT', '최적화VCT',
                ...
                '전진분석VC', '합계']
columns_sd   = ['period', 'time', 'dc', 'at', 'bet', 'seed', 'ttc', 'atc', 'mhc', 'aht', 'pc', 'mc', 'wr', 'app',
                'tpp', 'mdd', 'tsg', 'cagr']
