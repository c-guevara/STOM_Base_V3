...
from backtest import Visualization3D, get_result, bootstrap_test, send_result, plot_show, get_moneytop_query, \
    get_result_dataframe, add_mdd
from utility import stg_save_version, now, timedelta_day, str_ymd, str_ymdhms, dt_ymd, error_decorator, UI_NUM, \
    DB_STRATEGY, DB_BACKTEST, COLUMNS_BOT, DB_SETTING, DB_OPTUNA
...
class Total:
    ...
    def _report(self, list_tsg, arry_bct):
        ...
        df = pd.DataFrame([data], columns=COLUMNS_BOT, index=[self.file_name])
