...
from utility import now, str_ymdhms, error_decorator, DB_STRATEGY, DB_BACKTEST, UI_NUM, COLUMNS_BBT
from backtest import get_result, bootstrap_test, plot_show, get_moneytop_query, get_result_dataframe, add_mdd
...
class BackTest:
    ...
    def _report(self, list_tsg, arry_bct):
        ...
        df = pd.DataFrame([data], columns=COLUMNS_BBT, index=[save_time])
