...
class SetSetupTap:
    ...
    def set(self):
        ...
        self.ui.sj_set_pButton_01 = self.wc.setPushbutton('로딩', box=self.ui.sj_tab, animated=True, click=self.ui.SettingAllLoad)
        self.ui.sj_set_pButton_02 = self.wc.setPushbutton('설정', box=self.ui.sj_tab, animated=True, click=self.ui.SettingAllApp)
        self.ui.sj_set_pButton_03 = self.wc.setPushbutton('삭제', box=self.ui.sj_tab, animated=True, click=self.ui.SettingAllDel)
        self.ui.sj_set_liEditt_01 = self.wc.setLineedit(self.ui.sj_tab, style=style_bc_dk)
        self.ui.sj_set_pButton_04 = self.wc.setPushbutton('저장', box=self.ui.sj_tab, animated=True, click=self.ui.SettingAllSave)
        ...
        self.ui.sj_lvrg_Button_01 = self.wc.setPushbutton('레버리지 유형 및 수치 설정', box=self.ui.sj_bs_groupBox_01, click=self.ui.lvButtonClicked_01, animated=True, tip='바이낸스 선물 레버리지를 고정, 변동 형태 중 선택하여 설정한다.')
        ...
        self.ui.sj_load_Button_01 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_01, animated=True, click=self.ui.SettingLoad_01)
        self.ui.sj_load_Button_02 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_02, animated=True, click=self.ui.SettingLoad_02)
        self.ui.sj_load_Button_03 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_03, animated=True, click=self.ui.SettingLoad_03)
        self.ui.sj_load_Button_04 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_04, animated=True, click=self.ui.SettingLoad_04)
        self.ui.sj_load_Button_05 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_05, animated=True, click=self.ui.SettingLoad_05)
        self.ui.sj_load_Button_06 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_06, animated=True, click=self.ui.SettingLoad_06)
        self.ui.sj_load_Button_07 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_07, animated=True, click=self.ui.SettingLoad_07)
        self.ui.sj_load_Button_08 = self.wc.setPushbutton('불러오기', box=self.ui.sj_bs_groupBox_08, animated=True, click=self.ui.SettingLoad_08)

        self.ui.sj_save_Button_01 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_01, animated=True, click=self.ui.SettingSave_01)
        self.ui.sj_save_Button_02 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_02, animated=True, click=self.ui.SettingSave_02)
        self.ui.sj_save_Button_03 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_03, animated=True, click=self.ui.SettingSave_03)
        self.ui.sj_save_Button_04 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_04, animated=True, click=self.ui.SettingSave_04)
        self.ui.sj_save_Button_05 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_05, animated=True, click=self.ui.SettingSave_05)
        self.ui.sj_save_Button_06 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_06, animated=True, click=self.ui.SettingSave_06)
        self.ui.sj_save_Button_07 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_07, animated=True, click=self.ui.SettingSave_07)
        self.ui.sj_save_Button_08 = self.wc.setPushbutton('저장하기', box=self.ui.sj_bs_groupBox_08, animated=True, click=self.ui.SettingSave_08)

        self.ui.sj_etc_pButton_01 = self.wc.setPushbutton('계정 텍스트 보기', box=self.ui.ssd_tab, animated=True, click=self.ui.SettingAccView)
        self.ui.sj_etc_pButton_02 = self.wc.setPushbutton('경과틱수 변수설정', box=self.ui.sj_bs_groupBox_05, animated=True, click=self.ui.SettingStockElapsedTickNumber)
        self.ui.sj_etc_pButton_03 = self.wc.setPushbutton('경과틱수 변수설정', box=self.ui.sj_bs_groupBox_06, animated=True, click=self.ui.SettingCoinElapsedTickNumber)
