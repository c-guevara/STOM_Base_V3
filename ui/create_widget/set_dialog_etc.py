...
class SetDialogEtc:
    ...
    def set(self):
        ...
        self.ui.vlp_comboBoxxx_03 = self.wc.setCombobox(self.ui.dialog_pattern, hover=False, items=['10', '20', '30'])
        ...
        self.ui.vst_comboBoxxx_02 = self.wc.setCombobox(self.ui.dialog_pattern, hover=False, items=['10', '20', '30'])
