...
class SetTable:
    ...
    def set(self):
        ...
        self.ui.slbd_tableWidgett = self.wc.setTablewidget(self.ui.blv_tab, COLUMNS_SLT, 3)
        self.ui.slbt_tableWidgett = self.wc.setTablewidget(self.ui.blv_tab, COLUMNS_SLB, 26, vscroll=True)
